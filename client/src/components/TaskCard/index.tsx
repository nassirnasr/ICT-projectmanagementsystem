...
import ProjectViewPopup from '../ProjectCard/ProjectViewPopup';
...
const TaskCard = ({ task }: Props) => {
  ...
  return (
    <div>
      <div className="mb-4 rounded-lg bg-white p-6 shadow-lg dark:bg-dark-secondary dark:text-white" onClick={handleOpenPopup} style={{ cursor: 'pointer' }}>
        {/* Attachments */}
      ...
      {isPopupOpen && <ProjectViewPopup task={task} onClose={handleClosePopup} />}
    </div>
  );
};
